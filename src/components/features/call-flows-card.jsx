export default function CallFlowsCard() {
  return (
    <div className="bg-white">
      ...
      {/*      <rect x="15" y="25" width="20" height="3" fill="white" rx="1" />*/}
      {/*      <rect x="15" y="32" width="20" height="3" fill="white" rx="1" />*/}
      {/*      <rect x="15" y="39" width="15" height="3" fill="white" rx="1" />*/}
      {/*      <text*/}
      {/*        x="25"*/}
      {/*        y="65"*/}
      {/*        textAnchor="middle"*/}
      ...
      {/*        strokeWidth="1.5"*/}
      {/*      />*/}
      {/*      <text x="15" y="35" textAnchor="middle" fill="white" fontSize="8">*/}
      {/*        Team 1*/}
      {/*      </text>*/}
      ...
      {/*        strokeWidth="1.5"*/}
      {/*      />*/}
      {/*      <text x="15" y="75" textAnchor="middle" fill="white" fontSize="8">*/}
      {/*        Team 2*/}
      {/*      </text>*/}
      ...
      {/*        strokeWidth="1.5"*/}
      {/*      />*/}
      {/*      <text x="15" y="115" textAnchor="middle" fill="white" fontSize="8">*/}
      {/*        Team 3*/}
      {/*      </text>*/}
      {/*    </g>*/}
